...
/**
 * inorder_successor - this function returns the minimum value of a BST.
...
/**
 * bst_delete - this function deletes a node from a BST.
...
/**
 * bst_remove_recursive - this function removes a node from a BST recursively.
