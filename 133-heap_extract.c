...
/**
 * count_heap_nodes - this function counts the number of nodes inside a tree
...
/**
 * bubble_down - this function puts a node
 *value in a correct position in the heap
...
/**
 * get_parent - this function finds the parent node for a ceratin node
...
/**
 * heap_extract - this function extracts the max value of a heap
